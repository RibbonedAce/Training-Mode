...
int CPUAction_CheckMultipleState(GOBJ *cpu, int group_kind) {
    ...
    static u8 air_damage[] = {
        ASID_DAMAGEFLYHI, ASID_DAMAGEFLYN, ASID_DAMAGEFLYLW, ASID_DAMAGEFLYTOP, ASID_DAMAGEFLYROLL, ASID_DAMAGEFALL
    };
    static u8 jump_states[] = {ASID_JUMPF, ASID_JUMPB, ASID_JUMPAERIALF, ASID_JUMPAERIALB};
    static u8 fall_states[] = {ASID_FALL, ASID_FALLAERIAL, ASID_FALLAERIALF, ASID_FALLAERIALB};
    ...
    if (group_kind == ASID_ACTIONABLEGROUND) {
        ...
        for (int i = 0; i < sizeof(gr_actionable); i++) {
        ...
        for (int i = 0; i < sizeof(air_actionable); i++) {
        ...
        // check air actionable
        for (int i = 0; i < sizeof(air_damage); i++) {
        ...
        // jump states
        for (int i = 0; i < sizeof(jump_states); i++) {
        ...
        // fall states
        for (int i = 0; i < sizeof(fall_states); i++) {
